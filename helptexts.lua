...
local export_longdesc = {
	...
	["farming:cotton_8"] = "The cotton plant is a plant grown from cotton seed. It grows on wet soil or wet desert sand soil while being in direct sunlight. It will grow through 8 stages and stops growing at its final stage. Digging it will yield up to 2 cotton seeds and 2 cottons, the exact amount may vary. It can be dug at any stage, but only in its final stage you get the most out of it.",
