...
local export_longdesc = {
	...
	["default:stone"] = "A very common block in the world of Minetest. It sometimes contains ores. Usable for a variety in crafting recipes. Can be dug with a wooden pickaxe or better. Stone may be created when water meets lava.",
	...
	["default:water_source"] = "You can swim easily in water, but you need to catch your breath from time to time. When a water source meets a lava source, obsidian is created. When water meets lava, but one or both of them are not a source, a stone is created instead.",
	["default:river_water_source"] = "You can swim easily in river water, but you need to catch your breath from time to time. River water is similar to (normal) water, it has a reduced flowing range and appears in rivers only. When a river water source meets a lava source, obsidian is created. When river water meets lava, but one or both of them are not a source, a stone is created instead.",
	["default:lava_source"] = "Don't touch the lava, it will hurt you very much and once you're in, it is hard to get out. When a lava source meets a water or river water source, obsidian is created. When lava meets water or river water, but one or both of them are not a source, a stone is created instead.",
	...
	["farming:soil_wet"] = "Wet soil for farming, this is where you can plant and grow crops on. Wet soil is created when water is near soil. Wet soil will become (dry) soil again if there is no water nearby.",
	...
	["farming:wheat_8"] = "The wheat plant is a plant grown from wheat seed. It only grows on wet soil in direct sunlight. It will grow through 8 stages and stops growing at its final stage. Digging it will yield up to 2 wheat seeds and 2 wheat items. The drop probabilities are much lower if the plant is dug at an early stage with the risk to even get nothing at all; only at its final stage you are guaranteed to get at least 1 wheat seed and 1 wheat item.",
	["farming:cotton_8"] = "The cotton plant is a plant grown from wheat seed. It only grows on wet soil in direct sunlight. It will grow through 8 stages and stops growing at its final stage. Digging it will yield up to 2 cotton seeds and 2 cottons. The drop probabilities are much lower if the plant is dug at an early stage with the risk to even get nothing at all; only at its final stage you are guaranteed to get at least 1 cotton seed and 1 cotton.",
	...
	["vessels:pile_of_glass_fragments"] = craftitemdesc,
	...
	["default:obsidian_shard"] = craftitemdesc,
